...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def setUp(self):   #initialize the tests 
        """
        Setting up the environment
        """
        # mocking s3 connection start
        self.mock_s3 = mock_s3()  
        self.mock_s3.start()    #starting the mock s3
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Tests the list_files_in_prefix method for getting the 2 file keys as list on the mocket s3 bucket
        """
        # Expected results
        prefix_exp = 'prefix/'
